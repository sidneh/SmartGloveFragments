        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* if(empty){
                ...
                //String[] studyExercises = {"Resting_Hands_on_Thighs","Hold_Hands_Out","Finger_to_Nose","Finger_to_Nose","Finger_Tap","Finger_Tap","Closed_Grip","Closed_Grip","Hand_Flip","Hand_Flip","Toe_Tap","Toe_Tap","Heel_Stomp","Heel_Stomp","Walk_Steps"};
                //String[] studyExercises = {"Finger_to_Nose"};
                String[] studyExercises = {"Toe_Tap","Toe_Tap","Heel_Stomp","Heel_Stomp"};
